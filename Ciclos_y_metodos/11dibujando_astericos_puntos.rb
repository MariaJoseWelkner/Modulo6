# Dibuje puntos y asteriscos intercalados hasta n
# Donde n es un valor ingresado por el usuario al momento de ejecutar un script

print "Ingresa cuantos elementos quieres imprimir: "
n= gets.chomp.to_i
